...
<html lang="en">
    <head>
        ...
        <title>Endereço - Cadastro de Endereço</title>
                                        ...
                                        <form role="form">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-9">
                                                         ...
                                                         <input class="form-control" placeholder="Ex. logradouro">
                                                    </div>
                                                    <div class="col-md-3">
                                                       <label>Número</label>
                                                       <input class="form-control" placeholder="Ex. número">
                                                    </div>
                                                </div>
                                             </div>
                                             <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-6">
                                                        <label>Bairro</label>
                                                        <input class="form-control" placeholder="Ex. bairro">
                                                    </div>
                                                    <div class="col-md-3">
                                                       <label>Complemento</label>
                                                       <input class="form-control" placeholder="Ex. casa Z">
                                                    </div>
                                                    <div class="col-md-3">
                                                       <label>CEP</label>
                                                       <input class="form-control" placeholder="Ex. XX.XXX-XX">
                                                    </div>    
                                                </div>
                                             </div>
                                              ...
                                              <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-6">
                                                       ...
                                                       <input class="form-control" placeholder="Ex. (xx) xxxx-xxxx">
                                                    </div>
                                                    <div class="col-md-3">
                                                       <label>Cecular</label>
                                                       <input class="form-control" placeholder="Ex. (xx) xxxx-xxxx">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-6">
                                                       <label>País</label>
                                                       <input class="form-control" placeholder="Ex. Brasil">
                                                    </div>
                                                    <div class="col-md-3">
                                                       <label>Estado</label>
                                                       <select class="form-control" placeholder="BA">
