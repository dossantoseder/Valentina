...
<head>
        ...
        <title>Saints - As Melhores Experiências de Interação</title>

<!--<spring:url value="resources/css/bootstrap.min.css" var="bootstrapMin"></spring:url>
<spring:url value="resources/css/metisMenu.min.css" var="metisMenuMinCss"></spring:url>
<spring:url value="resources/css/timeline.css" var="timeLine"></spring:url>
<spring:url value="resources/css/startmin.css" var="starTminCss"></spring:url>
<spring:url value="resources/css/morris.css" var="morrisCss"></spring:url>
<spring:url value="resources/css/font-awesome.min.css" var="fontAwesomeMinCss"></spring:url>-->
        ...
        <!--<link rel="stylesheet" type="text/css" href="${metisMenuMinCss}" />-->

        <!-- Timeline CSS -->
        <link href="resources/css/timeline.css" rel="stylesheet">
       <!-- <link rel="stylesheet" type="text/css" href="${timeLine}" /> -->

        <!-- Custom CSS -->
        <link href="resources/css/startmin.css" rel="stylesheet">
       <!-- <link rel="stylesheet" type="text/css" href="${startMinCss}" />-->

        <!-- Morris Charts CSS -->
        <link href="resources/css/morris.css" rel="stylesheet">
       <!-- <link rel="stylesheet" type="text/css" href="${morrisCss}" />-->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-nav navbar-left navbar-top-links">
                    <li><a href="#"><i class="fa fa-home fa-fw"></i> Valentina</a></li>
                </ul>
